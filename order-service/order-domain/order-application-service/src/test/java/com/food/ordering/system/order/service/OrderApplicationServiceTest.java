...
class OrderApplicationServiceTest {
    ...
    private final UUID CUSTOMER_ID = UUID.fromString("a65f24c7-73b6-4cf6-8ad8-de3e5ebc00e9");
    private final UUID RESTAURANT_ID = UUID.fromString("5016e05e-6300-419a-bedd-9d54ee308f64");
    private final UUID PRODUCT_ID = UUID.fromString("9b394ac3-46e2-4a49-8b4a-2225f25b49c7");
    private final UUID ORDER_ID = UUID.fromString("c6ae68ee-3ec4-461e-b407-e5e9479d61fd");
    ...
    public void init(){
        ...
        when(restaurantRepository.findRestaurantInformation(orderDataMapper.createOrderComandToRestaurant(createOrderCommand)))
    ...
    void testCreateOrderWithWrongTotalPrice() {
        ...
        assertEquals("Total price 250.00 does not match items total 200.00!", orderDomainException.getMessage());
    }
